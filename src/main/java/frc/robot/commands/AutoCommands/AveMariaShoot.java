...
public class AveMariaShoot extends ParallelCommandGroup {
  /** Creates a new AveMariaShoot. */
  ArmSubsystem m_arm;
  WristSubsystem m_wrist;
  FalconShooter m_shooter;
  NodeSelector m_selector;

  public AveMariaShoot(ArmSubsystem m_arm, WristSubsystem m_wrist, FalconShooter m_shooter, 
  NodeSelector m_selector) {
    ...
    addCommands(
      m_arm.goToPosition(ArmConstants.AVE_MARIA_SHOOT_POSITION), 
